...
with_node \
  ...
  --target "/Users/liuzhao/Documents/Projects/cocowallet/frontend/ios/Pods/Target Support Files/Pods-CocoWallet/ExpoModulesProvider.swift" \
  --entitlement "/Users/liuzhao/Documents/Projects/cocowallet/frontend/ios/CocoWallet/CocoWallet.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-clipboard" "expo-constants" "expo-eas-client" "expo-file-system" "expo-font" "expo-keep-awake" "expo-linear-gradient" "expo-local-authentication" "expo-secure-store" "expo-system-ui" "expo-updates"
